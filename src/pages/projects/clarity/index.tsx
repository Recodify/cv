...
export default function Clarity({ onBack }: ProjectsProps) {
        ...
        <p>
          <div className="mt-4 bg-blue-50 p-4 rounded-md">
            ...
            <ul className="list-disc ml-6 mt-2">
              ...
              <li>Verify your CSV format using our <a href="#" className="text-blue-600 hover:underline">validation tool</a></li>
              <li>For files &gt;25MB, consider using the <a href="#" className="text-blue-600 hover:underline">Line Protocol</a> or splitting your files</li>
              <li>Use our <a href="#" className="text-blue-600 hover:underline">Python script</a> to convert standard CSVs to InfluxDB format</li>
            </ul>
          </div>
        </p>
        <div className='mt-4'>
...
,,0,2024-01-01T00:00:00Z,2024-01-02T00:00:00Z,2024-01-01T12:30:00Z,23.5,temperature,room_sensors,sensor_1`}
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-6 space-y-1">
          <li>Check our <a href="#" className="text-blue-600 hover:underline">troubleshooting guide</a></li>
          <li>Join our <a href="#" className="text-blue-600 hover:underline">community forum</a></li>
          <li>View <a href="#" className="text-blue-600 hover:underline">example datasets</a></li>
        </ul>
      </section>
    </article>
